...
## Project Structure
    ...
    ├── testapiautosetting_120461  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_120461`
...
2. Clone this repo and `cd testapiautosetting_120461`
